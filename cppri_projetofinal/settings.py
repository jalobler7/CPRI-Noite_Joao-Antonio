"""
Django settings for cppri_projetofinal project.
...
INSTALLED_APPS +=['home','abrigo', 'voluntarios','doacoes', ]
...
ROOT_URLCONF = 'cppri_projetofinal.urls'
...
WSGI_APPLICATION = 'cppri_projetofinal.wsgi.application'
